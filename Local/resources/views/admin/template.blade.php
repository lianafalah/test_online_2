      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href=""><i class="fa fa-circle-o"></i> Input Galery</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> Lihat Galery</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route ('kategori.create') }}"><i class="fa fa-circle-o"></i> Input Kategori</a></li>
            <li><a href="{{ url ('index_kategori') }}"><i class="fa fa-circle-o"></i> Lihat Kategori</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route ('transaksi.create') }}"><i class="fa fa-circle-o"></i> Input Transaksi</a></li>
            <li><a href="{{ url ('index_transaksi') }}"><i class="fa fa-circle-o"></i> Lihat Transaksi</a></li>
            <li><a href="{{ url ('index_bulanan') }}"><i class="fa fa-circle-o"></i> List Transaksi Default</a></li>
            <li><a href="{{ url ('list') }}"><i class="fa fa-circle-o"></i> List Transaksi </a></li>
          </ul>
        </li>
